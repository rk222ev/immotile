...
return (new CustomEvent(event_name,(function (){var obj23858 = {"detail":data};
return obj23858;
})()));
} else {
...
var f = (function (){var pred__23865 = cljs.core._EQ_;
var expr__23866 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__23865.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__23866))){
return ((function (pred__23865,expr__23866){
return (function (p1__23859_SHARP_){
return console.warn(p1__23859_SHARP_);
});
;})(pred__23865,expr__23866))
} else {
if(cljs.core.truth_(pred__23865.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__23866))){
return ((function (pred__23865,expr__23866){
return (function (p1__23860_SHARP_){
return console.debug(p1__23860_SHARP_);
});
;})(pred__23865,expr__23866))
} else {
if(cljs.core.truth_(pred__23865.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__23866))){
return ((function (pred__23865,expr__23866){
return (function (p1__23861_SHARP_){
return console.error(p1__23861_SHARP_);
});
;})(pred__23865,expr__23866))
} else {
return ((function (pred__23865,expr__23866){
return (function (p1__23862_SHARP_){
return console.log(p1__23862_SHARP_);
});
;})(pred__23865,expr__23866))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__23869){
...
var eval_fn = cljs.core.get.call(null,map__23870__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__23872_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__23874,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1535397860393
